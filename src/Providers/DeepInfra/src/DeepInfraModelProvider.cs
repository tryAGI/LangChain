...
public static class DeepInfraModelProvider
{
    private static Dictionary<DeepInfraModelIds, ChatModelMetadata> Models { get; set; } = new()
    {
        ...
        { DeepInfraModelIds.MetaLlama3405BInstruct, ToMetadata("meta-llama/Meta-Llama-3-405B-Instruct",null,0,0)},
        ...
        { DeepInfraModelIds.OpenChat35, ToMetadata("openchat/openchat_3.5",8192,7E-08,7E-08)},
