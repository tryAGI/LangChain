...
public class CohereCommandChatSettings : BedrockChatSettings
{
    public new static CohereCommandChatSettings Default { get; } = new()
    {
    ...
    public new static CohereCommandChatSettings Calculate(
        ChatSettings? requestSettings,
        ChatSettings? modelSettings,
        ChatSettings? providerSettings)
    {
        var requestSettingsCasted = requestSettings as CohereCommandChatSettings;
        var modelSettingsCasted = modelSettings as CohereCommandChatSettings;
        var providerSettingsCasted = providerSettings as CohereCommandChatSettings;

        return new CohereCommandChatSettings
        {
            StopSequences =
