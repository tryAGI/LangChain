...
public class AnthropicClaude3ChatSettings : BedrockChatSettings
{
    public new static AnthropicClaude3ChatSettings Default { get; } = new()
    {
    ...
    public new static AnthropicClaude3ChatSettings Calculate(
        ChatSettings? requestSettings,
        ChatSettings? modelSettings,
        ChatSettings? providerSettings)
    {
        var requestSettingsCasted = requestSettings as AnthropicClaude3ChatSettings;
        var modelSettingsCasted = modelSettings as AnthropicClaude3ChatSettings;
        var providerSettingsCasted = providerSettings as AnthropicClaude3ChatSettings;

        return new AnthropicClaude3ChatSettings
        {
            StopSequences =
