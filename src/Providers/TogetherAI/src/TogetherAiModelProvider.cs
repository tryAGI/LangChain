...
public static class TogetherAiModelProvider
{
    private static Dictionary<TogetherAiModelIds, ChatModels> Models { get; set; } = new()
    {
        ...
        { TogetherAiModelIds.Qwen15Chat110B, new ChatModels("Qwen/Qwen1.5-110B-Chat",32768,1.8000000000000001E-06,1.8000000000000001E-06)},
        ...
        { TogetherAiModelIds.DbrxInstruct, new ChatModels("databricks/dbrx-instruct",32768,1.2E-06,1.2E-06)},
