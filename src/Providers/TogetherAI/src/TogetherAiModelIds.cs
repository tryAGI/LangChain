...
public enum TogetherAiModelIds
{
    ...
    ///     ability to produce evocative storywriting and follow a narrative. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Austism/chronos-hermes-13b">https://huggingface.co/Austism/chronos-hermes-13b</a>
    /// </summary>
    ChronosHermes13B = 0,
    ...
    ///     front and end of a model <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Gryphe/MythoMax-L2-13b">https://huggingface.co/Gryphe/MythoMax-L2-13b</a>
    /// </summary>
    MythomaxL213B = 3,
    ...
    ///     in-house <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/NousResearch/Nous-Capybara-7B-V1p9">https://huggingface.co/NousResearch/Nous-Capybara-7B-V1p9</a>
    /// </summary>
    NousCapybaraV197B = 6,
    ...
    ///     Reasoning, GPT4All, and TruthfulQA. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/NousResearch/Nous-Hermes-2-Mistral-7B-DPO">https://huggingface.co/NousResearch/Nous-Hermes-2-Mistral-7B-DPO</a>
    /// </summary>
    ...
    ///     tasks. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/NousResearch/Nous-Hermes-2-Mixtral-8x7B-DPO">https://huggingface.co/NousResearch/Nous-Hermes-2-Mixtral-8x7B-DPO</a>
    /// </summary>
    ...
    ///     tasks. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/NousResearch/Nous-Hermes-2-Mixtral-8x7B-SFT">https://huggingface.co/NousResearch/Nous-Hermes-2-Mixtral-8x7B-SFT</a>
    /// </summary>
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/NousResearch/Nous-Hermes-2-Yi-34B">https://huggingface.co/NousResearch/Nous-Hermes-2-Yi-34B</a>
    /// </summary>
    NousHermes2Yi34B = 10,
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/NousResearch/Nous-Hermes-Llama2-13b">https://huggingface.co/NousResearch/Nous-Hermes-Llama2-13b</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/NousResearch/Nous-Hermes-llama-2-7b">https://huggingface.co/NousResearch/Nous-Hermes-llama-2-7b</a>
    /// </summary>
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Open-Orca/Mistral-7B-OpenOrca">https://huggingface.co/Open-Orca/Mistral-7B-OpenOrca</a>
    /// </summary>
    ...
    ///     proficient in Python, C/C++, TypeScript, Java, and more. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Phind/Phind-CodeLlama-34B-v2">https://huggingface.co/Phind/Phind-CodeLlama-34B-v2</a>
    /// </summary>
    ...
    ///     large amount of data. In comparison with the previous released Qwen. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Qwen/Qwen1.5-0.5B-Chat">https://huggingface.co/Qwen/Qwen1.5-0.5B-Chat</a>
    /// </summary>
    Qwen15Chat05B = 15,
    ...
    ///     large amount of data. In comparison with the previous released Qwen. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Qwen/Qwen1.5-1.8B-Chat">https://huggingface.co/Qwen/Qwen1.5-1.8B-Chat</a>
    /// </summary>
    Qwen15Chat18B = 17,
    ...
    ///     large amount of data. In comparison with the previous released Qwen. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Qwen/Qwen1.5-14B-Chat">https://huggingface.co/Qwen/Qwen1.5-14B-Chat</a>
    /// </summary>
    Qwen15Chat14B = 19,
    ...
    ///     large amount of data. In comparison with the previous released Qwen. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Qwen/Qwen1.5-32B-Chat">https://huggingface.co/Qwen/Qwen1.5-32B-Chat</a>
    /// </summary>
    Qwen15Chat32B = 21,
    ...
    ///     large amount of data. In comparison with the previous released Qwen. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Qwen/Qwen1.5-4B-Chat">https://huggingface.co/Qwen/Qwen1.5-4B-Chat</a>
    /// </summary>
    Qwen15Chat4B = 23,
    ...
    ///     large amount of data. In comparison with the previous released Qwen. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Qwen/Qwen1.5-72B-Chat">https://huggingface.co/Qwen/Qwen1.5-72B-Chat</a>
    /// </summary>
    Qwen15Chat72B = 25,
    ...
    ///     large amount of data. In comparison with the previous released Qwen. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Qwen/Qwen1.5-7B-Chat">https://huggingface.co/Qwen/Qwen1.5-7B-Chat</a>
    /// </summary>
    Qwen15Chat7B = 27,
    ...
    ///     merge use SLERP [TESTING] to merge ReML and Huginn v1.2. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/Undi95/ReMM-SLERP-L2-13B">https://huggingface.co/Undi95/ReMM-SLERP-L2-13B</a>
    /// </summary>
    RemmSlerpL213B = 30,
    ...
    ///     method to the domain of code. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/WizardLM/WizardCoder-15B-V1.0">https://huggingface.co/WizardLM/WizardCoder-15B-V1.0</a>
    /// </summary>
    ...
    ///     method to the domain of code. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/WizardLM/WizardCoder-Python-34B-V1.0">https://huggingface.co/WizardLM/WizardCoder-Python-34B-V1.0</a>
    /// </summary>
    ...
    ///     open-domain conversation capacities <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/WizardLM/WizardLM-13B-V1.2">https://huggingface.co/WizardLM/WizardLM-13B-V1.2</a>
    /// </summary>
    WizardlmV1213B = 35,
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/allenai/OLMo-7B-Instruct">https://huggingface.co/allenai/OLMo-7B-Instruct</a>
    /// </summary>
    OlmoInstruct7B = 36,
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-13b-Instruct-hf">https://huggingface.co/codellama/CodeLlama-13b-Instruct-hf</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-13b-Python-hf">https://huggingface.co/codellama/CodeLlama-13b-Python-hf</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-34b-Instruct-hf">https://huggingface.co/codellama/CodeLlama-34b-Instruct-hf</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-34b-Python-hf">https://huggingface.co/codellama/CodeLlama-34b-Python-hf</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-70b-Instruct-hf">https://huggingface.co/codellama/CodeLlama-70b-Instruct-hf</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-70b-Python-hf">https://huggingface.co/codellama/CodeLlama-70b-Python-hf</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-70b-hf">https://huggingface.co/codellama/CodeLlama-70b-hf</a>
    /// </summary>
    CodeLlama70B = 46,
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-7b-Instruct-hf">https://huggingface.co/codellama/CodeLlama-7b-Instruct-hf</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/codellama/CodeLlama-7b-Python-hf">https://huggingface.co/codellama/CodeLlama-7b-Python-hf</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/cognitivecomputations/dolphin-2.5-mixtral-8x7b">https://huggingface.co/cognitivecomputations/dolphin-2.5-mixtral-8x7b</a>
    /// </summary>
    ...
    ///     tokens, with a composition of 87% code and 13% natural language in both English and Chinese. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/deepseek-ai/deepseek-coder-33b-instruct">https://huggingface.co/deepseek-ai/deepseek-coder-33b-instruct</a>
    /// </summary>
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/deepseek-ai/deepseek-llm-67b-chat">https://huggingface.co/deepseek-ai/deepseek-llm-67b-chat</a>
    /// </summary>
    ...
    ///     Instruct v2 (70B) by upstage. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/garage-bAInd/Platypus2-70B-instruct">https://huggingface.co/garage-bAInd/Platypus2-70B-instruct</a>
    /// </summary>
    ...
    ///     research and technology used to create the Gemini models. <br />
    ...
    ///     ShareGPT. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/lmsys/vicuna-13b-v1.5">https://huggingface.co/lmsys/vicuna-13b-v1.5</a>
    /// </summary>
    VicunaV1513B = 57,
    ...
    ///     ShareGPT. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/lmsys/vicuna-7b-v1.5">https://huggingface.co/lmsys/vicuna-7b-v1.5</a>
    /// </summary>
    VicunaV157B = 58,
    ...
    ///     Available in three sizes: 7B, 13B and 70B parameters <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/meta-llama/Llama-2-13b-chat-hf">https://huggingface.co/meta-llama/Llama-2-13b-chat-hf</a>
    /// </summary>
    Llama2Chat13B = 59,
    ...
    ///     Available in three sizes: 7B, 13B and 70B parameters <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/meta-llama/Llama-2-70b-chat-hf">https://huggingface.co/meta-llama/Llama-2-70b-chat-hf</a>
    /// </summary>
    Llama2Chat70B = 61,
    ...
    ///     Available in three sizes: 7B, 13B and 70B parameters <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/meta-llama/Llama-2-7b-chat-hf">https://huggingface.co/meta-llama/Llama-2-7b-chat-hf</a>
    /// </summary>
    Llama2Chat7B = 63,
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.1">https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.1</a>
    /// </summary>
    ...
    ///     Mistral-7B-Instruct-v0.1. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.2">https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.2</a>
    /// </summary>
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/mistralai/Mixtral-8x7B-Instruct-v0.1">https://huggingface.co/mistralai/Mixtral-8x7B-Instruct-v0.1</a>
    /// </summary>
    ...
    ///     instruction data, with a custom processing pipeline. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/openchat/openchat-3.5-1210">https://huggingface.co/openchat/openchat-3.5-1210</a>
    /// </summary>
    OpenChat35 = 71,
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/snorkelai/Snorkel-Mistral-PairRM-DPO">https://huggingface.co/snorkelai/Snorkel-Mistral-PairRM-DPO</a>
    /// </summary>
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/teknium/OpenHermes-2-Mistral-7B">https://huggingface.co/teknium/OpenHermes-2-Mistral-7B</a>
    /// </summary>
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/teknium/OpenHermes-2p5-Mistral-7B">https://huggingface.co/teknium/OpenHermes-2p5-Mistral-7B</a>
    /// </summary>
    ...
    ///     recipe and system optimizations, instruction tuned by Together <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/togethercomputer/Llama-2-7B-32K-Instruct">https://huggingface.co/togethercomputer/Llama-2-7B-32K-Instruct</a>
    /// </summary>
    ...
    ///     RedPajama-INCITE-Base-7B-v1 base model. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/togethercomputer/RedPajama-INCITE-7B-Chat">https://huggingface.co/togethercomputer/RedPajama-INCITE-7B-Chat</a>
    /// </summary>
    ...
    ///     Completion Cost: $0.1/MTok <br />
    ///     Description: Chat model fine-tuned using data from Dolly 2.0 and Open Assistant over the
    ///     RedPajama-INCITE-Base-3B-v1 base model. <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/togethercomputer/RedPajama-INCITE-Chat-3B-v1">https://huggingface.co/togethercomputer/RedPajama-INCITE-Chat-3B-v1</a>
    /// </summary>
    ...
    ///     in Hyena blocks, different from traditional decoder-only Transformers <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/togethercomputer/StripedHyena-Nous-7B">https://huggingface.co/togethercomputer/StripedHyena-Nous-7B</a>
    /// </summary>
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/togethercomputer/alpaca-7b">https://huggingface.co/togethercomputer/alpaca-7b</a>
    /// </summary>
    Alpaca7B = 91,
    ...
    ///     <br />
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/upstage/SOLAR-10.7B-Instruct-v1.0">https://huggingface.co/upstage/SOLAR-10.7B-Instruct-v1.0</a>
    /// </summary>
    ...
    ///     HuggingFace Url:
    ///     <a href="https://huggingface.co/zero-one-ai/Yi-34B-Chat">https://huggingface.co/zero-one-ai/Yi-34B-Chat</a>
    /// </summary>
    _01AiYiChat34B = 100
}