    ...
    public static class OpenRouterModelProvider
    {
        ...
        static OpenRouterModelProvider()
        {
            var dic = new Dictionary<OpenRouterModelIds, ChatModels>
            {
                ...
                { OpenRouterModelIds.MetaCodellama34BInstruct, new ChatModels("meta-llama/codellama-34b-instruct", 8192, 4E-07, 4E-07) },
                { OpenRouterModelIds.PhindCodellama34Bv2, new ChatModels("phind/phind-codellama-34b", 4096, 4E-07, 4E-07) },
                ...
                { OpenRouterModelIds.Synthia70B, new ChatModels("migtissera/synthia-70b", 8192, 3.75E-06, 3.75E-06) },
                ...
                { OpenRouterModelIds.Noromaid20B, new ChatModels("neversleep/noromaid-20b", 8192, 2.25E-06, 2.25E-06) },
                ...
                { OpenRouterModelIds.OpenHermes25Mistral7B, new ChatModels("teknium/openhermes-2.5-mistral-7b", 4096, 1.8E-07, 1.8E-07) },
                { OpenRouterModelIds.RemmSlerp13B, new ChatModels("undi95/remm-slerp-l2-13b", 4096, 2.7E-07, 2.7E-07) },
                { OpenRouterModelIds.ToppyM7B, new ChatModels("undi95/toppy-m-7b", 4096, 1.8E-07, 1.8E-07) },
                { OpenRouterModelIds.Cinematika7BAlpha, new ChatModels("openrouter/cinematika-7b", 8000, 1.8E-07, 1.8E-07) },
                ...
                { OpenRouterModelIds.MistralOpenOrca7B, new ChatModels("open-orca/mistral-7b-openorca", 8192, 1.425E-07, 1.425E-07) },
                { OpenRouterModelIds.HuggingFaceZephyr7B, new ChatModels("huggingfaceh4/zephyr-7b-beta", 4096, 1.425E-07, 1.425E-07) },
                ...
                { OpenRouterModelIds.OpenAiGpt4Turbo, new ChatModels("openai/gpt-4-turbo-preview", 128000, 1E-05, 3E-05) },
                ...
                { OpenRouterModelIds.PerplexityPplx7BOnline, new ChatModels("perplexity/pplx-7b-online", 4096, 2E-07, 2E-07) },
                { OpenRouterModelIds.PerplexityPplx7BChat, new ChatModels("perplexity/pplx-7b-chat", 8192, 2E-07, 2E-07) },
                { OpenRouterModelIds.PerplexityPplx70BChat, new ChatModels("perplexity/pplx-70b-chat", 4096, 1E-06, 1E-06) },
                { OpenRouterModelIds.PerplexitySonar7B, new ChatModels("perplexity/sonar-small-chat", 16384, 2E-07, 2E-07) },
                { OpenRouterModelIds.PerplexitySonar8X7B, new ChatModels("perplexity/sonar-medium-chat", 16384, 6E-07, 6E-07) },
                { OpenRouterModelIds.PerplexitySonar7BOnline, new ChatModels("perplexity/sonar-small-online", 12000, 2E-07, 2E-07) },
                ...
                { OpenRouterModelIds.AnthropicClaudeInstantV1, new ChatModels("anthropic/claude-instant-1", 100000, 8E-07, 2.4E-06) },
                { OpenRouterModelIds.AnthropicClaudeInstantV12, new ChatModels("anthropic/claude-instant-1.2", 100000, 8E-07, 2.4E-06) },
                ...
                { OpenRouterModelIds.AnthropicClaudeInstantV1SelfModerated, new ChatModels("anthropic/claude-instant-1:beta", 100000, 8E-07, 2.4E-06) },
                ...
                { OpenRouterModelIds.Mythomax13BNitro, new ChatModels("gryphe/mythomax-l2-13b:nitro", 4096, 2E-07, 2E-07) },
                { OpenRouterModelIds.Mistral7BInstructNitro, new ChatModels("mistralai/mistral-7b-instruct:nitro", 32768, 2E-07, 2E-07) },
                { OpenRouterModelIds.GoogleGemma7BNitro, new ChatModels("google/gemma-7b-it:nitro", 8192, 2E-07, 2E-07) },
