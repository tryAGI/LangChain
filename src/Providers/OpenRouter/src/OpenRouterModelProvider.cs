...
public static class OpenRouterModelProvider
{
    private static Dictionary<OpenRouterModelIds, ChatModels> Models { get; set; } = new()
    {
        ...
        { OpenRouterModelIds.Fimbulvetr11BV2, new ChatModels("sao10k/fimbulvetr-11b-v2",8192,0,0)},
        ...
        { OpenRouterModelIds.MetaLlama38BInstructExtended, new ChatModels("meta-llama/llama-3-8b-instruct:extended",16384,0,0)},
        ...
        { OpenRouterModelIds.MetaLlama370BInstruct, new ChatModels("meta-llama/llama-3-70b-instruct",8192,0,0)},
        ...
        { OpenRouterModelIds.OpenAiGpt35Turbo, new ChatModels("openai/gpt-3.5-turbo",16385,0,0)},
        ...
        { OpenRouterModelIds.OpenAiGpt4Turbo, new ChatModels("openai/gpt-4-turbo",128000,0,0)},
        { OpenRouterModelIds.OpenAiGpt4TurboPreview, new ChatModels("openai/gpt-4-turbo-preview",128000,0,0)},
        ...
        { OpenRouterModelIds.GooglePalm2Chat, new ChatModels("google/palm-2-chat-bison",25804,0,0)},
        { OpenRouterModelIds.GooglePalm2CodeChat, new ChatModels("google/palm-2-codechat-bison",20070,0,0)},
        { OpenRouterModelIds.GooglePalm2Chat32K, new ChatModels("google/palm-2-chat-bison-32k",91750,0,0)},
        { OpenRouterModelIds.GooglePalm2CodeChat32K, new ChatModels("google/palm-2-codechat-bison-32k",91750,0,0)},
        { OpenRouterModelIds.GoogleGeminiPro10, new ChatModels("google/gemini-pro",91728,0,0)},
        { OpenRouterModelIds.GoogleGeminiProVision10, new ChatModels("google/gemini-pro-vision",45875,0,0)},
        { OpenRouterModelIds.GoogleGeminiPro15Preview, new ChatModels("google/gemini-pro-1.5",2800000,0,0)},
        ...
        { OpenRouterModelIds.PerplexitySonar7BOnline, new ChatModels("perplexity/sonar-small-online",12000,0,0)},
        { OpenRouterModelIds.PerplexitySonar8X7BOnline, new ChatModels("perplexity/sonar-medium-online",12000,0,0)},
        { OpenRouterModelIds.Firellava13B, new ChatModels("fireworks/firellava-13b",4096,0,0)},
        ...
        { OpenRouterModelIds.Zephyr141BA35b, new ChatModels("huggingfaceh4/zephyr-orpo-141b-a35b",65536,0,0)},
        { OpenRouterModelIds.MetaLlama38BInstruct, new ChatModels("meta-llama/llama-3-8b-instruct",8192,0,0)},
        { OpenRouterModelIds.Wizardlm27B, new ChatModels("microsoft/wizardlm-2-7b",32000,0,0)},
        { OpenRouterModelIds.MistralMixtral8X22BBase, new ChatModels("mistralai/mixtral-8x22b",65536,0,0)},
        { OpenRouterModelIds.MistralMixtral8X22bInstruct, new ChatModels("mistralai/mixtral-8x22b-instruct",65536,0,0)},
        ...
        { OpenRouterModelIds.ToppyM7BNitro, new ChatModels("undi95/toppy-m-7b:nitro",4096,0,0)},
        { OpenRouterModelIds.Wizardlm28X22bNitro, new ChatModels("microsoft/wizardlm-2-8x22b:nitro",65536,0,0)},
        { OpenRouterModelIds.MetaLlama38BInstructNitro, new ChatModels("meta-llama/llama-3-8b-instruct:nitro",8192,0,0)},
        { OpenRouterModelIds.MetaLlama370BInstructNitro, new ChatModels("meta-llama/llama-3-70b-instruct:nitro",8192,0,0)},
