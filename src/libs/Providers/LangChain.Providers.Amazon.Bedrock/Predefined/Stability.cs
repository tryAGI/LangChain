...
public class StableDiffusionExtraLargeV0Model(BedrockProvider provider)
    : StableDiffusionImageGenerationModel(provider, id: "stability.stable-diffusion-xl-v0");

/// <inheritdoc />
public class StableDiffusionExtraLargeV1Model(BedrockProvider provider)
    : StableDiffusionImageGenerationModel(provider, id: "stability.stable-diffusion-xl-v1");